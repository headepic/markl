...
```
npx skills add alchaincyf/design
```

[See it work](#demo-gallery) · [Install](#install) · [What it does](#what-it-does) · [How it works](#core-mechanics) · [vs. Design](#vs-design)
...
<p align="center">
  <video src="https://github.com/alchaincyf/design/releases/download/v2.0/hero-animation-v10-en.mp4" autoplay muted loop playsinline width="100%">
    Your browser doesn't support inline video. <a href="https://github.com/alchaincyf/design/releases/download/v2.0/hero-animation-v10-en.mp4">Download MP4</a>.
  </video>
</p>

<p align="center"><sub>▲ 10-second hero animation showing what design does (<a href="https://github.com/alchaincyf/design/releases/download/v2.0/hero-animation-v10-en.mp4">download MP4</a> if autoplay doesn't work)</sub></p>
...
<p align="center">
  <a href="https://star-history.com/#alchaincyf/design&Date">
    <img src="https://api.star-history.com/svg?repos=alchaincyf/design&type=Date" alt="design Star History" width="80%">
  </a>
</p>
...
<p align="center"><img src="https://github.com/alchaincyf/design/releases/download/v2.0/w3-fallback-advisor-en.gif" width="100%"></p>
...
<p align="center"><img src="https://github.com/alchaincyf/design/releases/download/v2.0/c1-ios-prototype-en.gif" width="100%"></p>
...
<p align="center"><img src="https://github.com/alchaincyf/design/releases/download/v2.0/c3-motion-design-en.gif" width="100%"></p>
...
<p align="center"><img src="https://github.com/alchaincyf/design/releases/download/v2.0/c2-slides-pptx-en.gif" width="100%"></p>
...
<p align="center"><img src="https://github.com/alchaincyf/design/releases/download/v2.0/c4-tweaks-en.gif" width="100%"></p>
...
<p align="center"><img src="https://github.com/alchaincyf/design/releases/download/v2.0/c5-infographic-en.gif" width="100%"></p>
...
<p align="center"><img src="https://github.com/alchaincyf/design/releases/download/v2.0/c6-expert-review-en.gif" width="100%"></p>
...
<p align="center"><img src="https://github.com/alchaincyf/design/releases/download/v2.0/w2-junior-designer-en.gif" width="100%"></p>
...
<p align="center"><img src="https://github.com/alchaincyf/design/releases/download/v2.0/w1-brand-protocol-en.gif" width="100%"></p>
...
I'll be upfront: the Core Asset Protocol's philosophy was lifted from system prompts Anthropic wrote for Design. That prompt hammers home a single idea — **great hi-fi design doesn't start from a blank page, it grows from existing design context**. That one principle is the difference between a 65-point design and a 90-point design.
...
Design is a **better graphics tool**. Design makes **the graphics-tool layer disappear**. Two paths, different audiences.
...
The day Anthropic launched Design I played with it until 4 a.m. A few days later I realized I hadn't opened it once since — not because it's bad (it's the most polished product in the category) but because I'd rather have an agent work in my terminal than open any graphical UI.

So I had an agent deconstruct Design itself (including the system prompts circulating in the community, the brand asset protocol, the component mechanics), distill it into a structured spec, then write it as a skill installed in my own Claude Code.

Thanks to Anthropic for writing the Design prompts so clearly. This kind of derivative work inspired by other products is the new form of open-source culture in the AI era.
